export default function Head() {
  return (
    <>
      ...
      {/* <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            text: "A1Z26 tool to assist 'O Enigma do Sol Oculto players', convert letters to numbers. Numbering the letters so A=1, Z=26, etc is one of the simplest ways of converting them to numbers.",
            reviewAspect: ["Cypher", "Enigma", "Puzzle", "Cifra", "Code"],
            author: {
              "@type": "Person",
              ...
              image: "https://a1z26.bermeo.dev/Logo.svg",
      ...
      <link rel="canonical" href="https://a1z26.bermeo.dev/" key="canonical" />
